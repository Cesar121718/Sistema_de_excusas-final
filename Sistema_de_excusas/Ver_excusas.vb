...
Public Class Ver_excusas
    ...
    Private Sub Ver_excusas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'BDExcusasDataSet1.Excusas' Puede moverla o quitarla según sea necesario.
        Me.ExcusasTableAdapter.Fill(Me.BDExcusasDataSet1.Excusas)
