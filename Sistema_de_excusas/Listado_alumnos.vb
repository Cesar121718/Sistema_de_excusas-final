...
Public Class Listado_alumnos
    ...
    Private Sub Listado_alumnos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'BDExcusasDataSet1.Alumnos' Puede moverla o quitarla según sea necesario.
        Me.AlumnosTableAdapter.Fill(Me.BDExcusasDataSet1.Alumnos)
